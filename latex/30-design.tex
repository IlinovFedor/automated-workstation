...
API сервера предоставляет эндпоинты для просмотра расписания в разрезе учебных групп, преподавателей, аудиторий и дисциплин.

Система состоит из нескольких компонентов:
\begin{enumerate}
\item \textbf{База данных} (PostgreSQL)---хранение справочных данных и информации о занятиях;
...
Аналогичную структуру имеют и прочие редакторы. Каждый из них зависит от OAIDefaultApi и построен по тому же принципу, что и LocationsEditorWidget.