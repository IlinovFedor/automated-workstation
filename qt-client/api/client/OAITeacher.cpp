...
OAITeacher::OAITeacher(const QString &json) {
...
void OAITeacher::fromJson(const QString &jsonString) {
...
qint32 OAITeacher::getId() const {
    return m_id;
}
void OAITeacher::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}
...
QString OAITeacher::getName() const {
    return m_name;
}
void OAITeacher::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}
