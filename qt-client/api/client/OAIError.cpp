...
OAIError::OAIError(const QString &json) {
...
void OAIError::fromJson(const QString &jsonString) {
...
QString OAIError::getFile() const {
    return m_file;
}
void OAIError::setFile(const QString &file) {
    m_file = file;
    m_file_isSet = true;
}

bool OAIError::is_file_Set() const{
    return m_file_isSet;
}

bool OAIError::is_file_Valid() const{
